...
<hr size="5" color="skyblue">
 <% List<RequestDetails> requestlist =
            (List<RequestDetails>)request.getAttribute("reqlist");
   %>
           ...
           <tr>
            ...
            %>	   
                  <tr>
                     ...
                     <td><%=reqobj.getdate()%></td>
                     <td><%=reqobj.gettime()%></td>
                     <td><%=reqobj.getcomment()%></td>
                     <td><%=reqobj.getstatus()%></td>
                     <td><a class="link" href="UpdateRequestServlet?requestid=<%=reqobj.getrequestid()%>&propid=<%=reqobj.getpropertyid()%>">Approve</a></td>
                    </tr>
             <%   
               }
            %>
